...
Params::Params(std::string pathToInstance, int nbVeh, int seedRNG, int InitCntrys, int NumImps, double RevolRate) : nbVehicles(nbVeh)
{
	...
	NumOfCountries = InitCntrys;
	NumOfInitialImperialists = NumImps;
	RevolutionRate = RevolRate;
	NumOfAllColonies = NumOfCountries - NumOfInitialImperialists;
